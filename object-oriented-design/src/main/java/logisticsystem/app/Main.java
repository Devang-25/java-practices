...
import logisticsystem.domain.Item;
import logisticsystem.domain.Location;
import logisticsystem.domain.Order;
import logisticsystem.domain.OrderStatus;
import logisticsystem.domain.PaymentDetails;
import logisticsystem.domain.PaymentMode;
...
public class Main { 
    ...
    { 
        ...
        order.setDeliveryAddress(destination);
        order.setPaymentDetail(paymentDetails); 
